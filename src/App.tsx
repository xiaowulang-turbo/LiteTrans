...
import { VersionBlocker } from './components/VersionBlocker'
...
function App() {
  ...
  const { versionCheck, isChecking: versionChecking } = useVersionCheck()
  ...
  return (
    <>
      <VersionBlocker blockInfo={versionCheck} />
      <Suspense fallback={
