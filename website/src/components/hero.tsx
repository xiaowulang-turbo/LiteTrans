    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass mb-8">
          ...
          <span className="text-sm text-muted-foreground">macOS 专属翻译工具</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button size="lg" className="h-12 px-8 text-base bg-primary hover:bg-primary/90 glow">
            <AppleIcon className="w-5 h-5 mr-2" />
            下载 macOS 版本
          </Button>
          <Button size="lg" variant="outline" className="h-12 px-8 text-base glass glass-hover">
            了解更多
          </Button>
        </div>
